export default [
  ...
  {
    id: 2,
    deptName: "Machine Learning Department",
    purpose:
   ...
   teamLeads: [
    ...
    projects: [
      ...
      {
        id: 2,
        title: "Collaboration with BNP Paribas Corporate Treasury",
        details: [
  ...
  },
  {
    ...
    purpose:
      "Execute and control the whole process of company operation and management.",
    teamLeads: [
      {
        name: 'Michael Tan',
        src: '/images/michael_tan.png'
